...
type Snapshot struct {
	...
	CurrentCounts     map[string]CurrentCounts    `json:"current_counts,omitempty"`
	Settings          map[string]json.RawMessage  `json:"settings,omitempty"`
	RawFiles          map[string]string           `json:"raw_files,omitempty"`
}

func EmptySnapshot() Snapshot {
	return Snapshot{CurrentQueueIndex: -1, Songs: map[string]Song{}, Favorites: map[string]bool{}, PeriodCounts: map[string]map[string]int64{}, CurrentCounts: map[string]CurrentCounts{}, Settings: map[string]json.RawMessage{}, RawFiles: map[string]string{}}
}
