...
func Load() (Config, error) {
	...
	c := Config{
		...
		AgentBootstrapToken: os.Getenv("MUSICOLET_AGENT_TOKEN"), MasterKey: os.Getenv("MUSICOLET_MASTER_KEY"),
		PublicBaseURL:  strings.TrimRight(os.Getenv("MUSICOLET_PUBLIC_BASE_URL"), "/"),
	...
	if len(c.MasterKey) < 24 {
		return Config{}, errors.New("MUSICOLET_MASTER_KEY is required and must be at least 24 characters")
	}
